...
public enum ErrorCode {
    ...
    UNSUPPORTED_IMAGE_EXTENSION(HttpStatus.BAD_REQUEST, "B007", "지원하지 않는 이미지 확장자입니다."),
    UNSUPPORTED_VIDEO_EXTENSION(HttpStatus.BAD_REQUEST, "B008", "지원하지 않는 동영상 확장자입니다."),
    INVALID_FILE_EXTENSION(HttpStatus.BAD_REQUEST, "B009", "파일 확장자가 올바르지 않습니다."),
    INVALID_TAG_CATEGORY(HttpStatus.NOT_FOUND, "B011", "유효한 카테고리를 찾을 수 없습니다."),
    INVALID_TAG_SELECTION(HttpStatus.BAD_REQUEST, "B012", "카테고리에 맞지 않거나 존재하지 않는 태그가 포함되어 있습니다."),
    DUPLICATE_TAG_IN_LIST(HttpStatus.BAD_REQUEST, "B015", "태그 목록에 중복된 값이 있습니다."),
    INVALID_SHORTFORM_TARGET(HttpStatus.BAD_REQUEST, "B016", "seriesId와 contentsId 중 하나만 제공해야 합니다."),
    INVALID_SHORTFORM_CONTENTS_TARGET(HttpStatus.BAD_REQUEST, "B017", "시리즈에 속한 콘텐츠는 숏폼 원본으로 선택할 수 없습니다."),
    SHORTFORM_ORIGIN_MEDIA_NOT_FOUND(HttpStatus.NOT_FOUND, "B018", "숏폼 원본 미디어를 찾을 수 없습니다.")
    ;
