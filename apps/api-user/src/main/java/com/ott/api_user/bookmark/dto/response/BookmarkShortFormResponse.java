...
public class BookmarkShortFormResponse {
    ...
    @Schema(description = "미디어 제목", example = "김마루의 숏폼 EP 01")
    private String title;

    @Schema(description = "미디어 설명", example = "오늘은 북마크 API를 작성했다. 참 재미있었다!")
    private String description;

    @Schema(description = "썸네일 URL", example = "https://cdn.ott.com/thumbnails/1.jpg")
